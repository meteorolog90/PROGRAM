...
urlpatterns = [
	...
	path('<year>/<year1>/<lon>/<lat>/', views.period_year_prec, name = 'period_year_prec'),
	path('<year>/<month>/<year1>/<month1>/<lon>/<lat>/', views.period_month_prec, name = 'period_month_prec'),
